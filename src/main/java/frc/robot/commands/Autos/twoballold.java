...
public class twoballold extends SequentialCommandGroup {

    public twoballold(Drivetrain drive, Intake intake, Shooter shooter, ShooterHood hood, Elevator top, XboxController operator) {
